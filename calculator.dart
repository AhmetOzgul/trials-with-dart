...
// Hangi işlemin yapılacağını belirleyen fonksiyon
  switch(secim){
    case 0: print("Çıkış yapılıyor.\n---------------\n");
    case 1: hesapla("Toplama");
    case 2: hesapla("Çıkarma");
    case 3: hesapla("Çarpma");
    case 4: hesapla("Bölme");
    default: print("Geçersiz bir sayı girdiniz.\n\n");
  }
}
...
void hesapla(String islem){
    ...
    switch(islem){
      case "Toplama": toplama(x,y);
      case "Çıkarma": cikarma(x,y);
      case "Çarpma": carpma(x,y);
      case "Bölme": bolme(bolunen: x,bolen: y);
    }
    print("\n---------------\n");
    main();
}
